...
| Case Study                                         | Concept               |     |
|----------------------------|----------------------|----------------------|
| Data-breach incidents by US state                  | R Basics              |     |
| Reaction times in an online task                   | Statistical Summaries |     |
| Trends in global tech adoption                      | Data Visualization    |     |
| The impact of a free feature bundle on fitness-app downloads | Data Visualization    |     |
| Self-reported daily screen time (mixed formats)    | Data Wrangling        |     |
