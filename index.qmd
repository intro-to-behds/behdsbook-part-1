...
The websites for the two parts of the book are the following:

- Part 1 **Data Wrangling and Visualization with R** part is [here](https://intro-to-behds.github.io/behdsbook-part-1/)[^index-orig-1].
- Part 2 **Statistics and Prediction Algorithms Through Case Studies** part is [here](https://intro-to-behds.github.io/behdsbook-part-2/)[^index-orig-2].

[^index-orig-1]: The link to the original version by Irizarry is the following one: <http://rafalab.dfci.harvard.edu/dsbook-part-1/>
[^index-orig-2]: The link to the original version by Irizarry is the following one: <http://rafalab.dfci.harvard.edu/dsbook-part-2/>
...
The English translation and adaptation were produced with the assistance of _Claude Code (Sonnet 4.6)_. The model was used for programming, language revision, and to help "reflavour" the examples; LLM were not used to generate new ideas or to decide the content.
:::
...
The Quarto files used to generate the original book is available on [GitHub](https://github.com/rafalab/dsbook-part-1)[^index-4]. Note that, the graphical theme used for plots throughout the book can be recreated using the `ds_theme_set()` function from the **behdslabs** package.
