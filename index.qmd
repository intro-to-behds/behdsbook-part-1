...
- Part 1 **Data Wrangling and Visualization with R** part is [here](https://intro-to-behds.github.io/behdsbook-part-1/)[^index-1].
- Part 2 **Statistics and Prediction Algorithms Through Case Studies** part is [here](https://intro-to-behds.github.io/behdsbook-part-2/)[^index-2].
